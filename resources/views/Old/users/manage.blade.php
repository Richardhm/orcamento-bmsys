<x-app-layout>
    ...
    <div class="flex justify-between items-center">
            ...
            <div class="mr-8 bg-white rounded-lg">
                <strong class="text-red-500 text-2xl preco_total p-4">R$ {{ number_format($assinatura->preco_total, 2, ',', '.') }}</strong>
            </div>
...
{{--    </div>--}}
    ...
    <div class="md:w-[70%] mt-5 mx-auto" id="user-table">
        @include('partials.user-table', ['users' => $users])
    </div>
