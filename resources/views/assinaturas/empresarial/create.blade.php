<x-guest-layout>
    ...
    <section style="width:380px;border-radius: 5px;">
        ...
        <form method="POST" action="{{ route('assinaturas.empresarial.store') }}" class="p-2" enctype="multipart/form-data">
            <input type="hidden" name="_token" value="{{ csrf_token() }}" />
            <div class="mb-2">
                <label for="name" class="block mb-1 font-medium text-white dark:text-white text-sm">Nome:</label>
                <input type="text" name="name" id="name" placeholder="Seu Nome" style="color:black;" class="bg-gray-50 border border-gray-300 text-gray-950 text-sm block w-full p-2.5 focus:border-transparent focus:ring-0 focus:outline-none rounded-lg" required />
            ...
            <div class="mb-2">
                ...
                <div class="relative">
                    <input type="password" name="password" id="password" placeholder="Sua Senha" style="color:black;" class="bg-gray-50 border text-gray-950 border-gray-300 text-sm block w-full p-2.5 focus:border-transparent focus:ring-0 focus:outline-none rounded-lg" required />
