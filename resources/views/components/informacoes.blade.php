<div class="mt-2 rounded p-1 bg-[rgba(254,254,254,0.18)] backdrop-blur-[15px] border border-black dark:border-white w-full lg:w-[22%]" id="container_informacoes">
    <button class="py-2 w-full px-1 me-2 mb-2 text-sm font-medium dark:text-white text-black rounded-lg border border-black dark:border-gray-200 dark:bg-gray-500 dark:bg-opacity-10">
        Tabela de Origem
    </button>
    ...
    <div class="flex flex-wrap justify-around" id="faixa_etarias">
        <div class="flex flex-col w-[40%]">
            <div class="mb-2 w-full">
                ...
                <span class="dark:text-white text-black text-sm">0 - 18</span>

                <div class="flex items-center align-center text-center">

                    <div class="flex rounded overflow-hidden border border-black dark:border-gray-200 align-center text-center mx-auto faixa-etaria-buttons h-8">
            ...
            <div class="mb-2">
                <span class="dark:text-white text-black text-sm">24 - 28</span>
            ...
            <div class="mb-2">
                <span class="dark:text-white text-black text-sm">34 - 38</span>
            ...
            <div class="mb-2">
                <span class="dark:text-white text-black text-sm">44 - 48</span>
                <div class="flex items-center">
                    <div class="flex rounded overflow-hidden border border-black dark:border-gray-200 align-center text-center mx-auto faixa-etaria-buttons h-8">
                        <button class="bg-red-400 text-gray-500 minus w-10 text-white flex-grow" style="width:33%;">-</button>
            ...
            <div class="mb-2">
                <span class="dark:text-white text-black text-sm">54 - 58</span>
                <div class="flex items-center">
                    <div class="flex rounded overflow-hidden border border-black dark:border-gray-200 align-center text-center mx-auto faixa-etaria-buttons h-8">
                        <button class="bg-red-400 text-gray-500 minus w-10 text-white flex-grow" style="width:33%;">-</button>
        ...
        <div class="flex flex-col w-[40%]">
            ...
            <div class="mb-2">
                <span class="dark:text-white text-black text-sm">19 - 23</span>
                <div class="flex items-center">
            ...
            <div class="mb-2">
                <span class="dark:text-white text-black text-sm">29 - 33</span>
                <div class="flex items-center">
            ...
            <div class="mb-2">
                <span class="dark:text-white text-black text-sm">39 - 43</span>
                <div class="flex items-center">
                    <div class="flex rounded overflow-hidden border border-black dark:border-gray-200 align-center text-center mx-auto faixa-etaria-buttons h-8">
                        <button class="bg-red-400 text-gray-500 minus w-10 text-white flex-grow" style="width:33%;">-</button>
            ...
            <div class="mb-2">
                <span class="dark:text-white text-black text-sm">49 - 53</span>
                <div class="flex items-center">
                    <div class="flex rounded overflow-hidden border border-black dark:border-gray-200 align-center text-center mx-auto faixa-etaria-buttons h-8">
                        <button class="bg-red-400 text-gray-500 minus w-10 text-white flex-grow" style="width:33%;">-</button>
            ...
            <div class="mb-2">
                <span class="dark:text-white text-black text-sm">Acima 59+</span>
